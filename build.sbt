...
lazy val applicationDependencies = Seq(
  ...
  "com.softwaremill.sttp.client3" %% "async-http-client-backend"      % Versions.SttpClientVersion,
  "com.softwaremill.sttp.client3" %% "async-http-client-backend-cats" % Versions.SttpClientVersion,
  "com.softwaremill.sttp.client3" %% "circe"                          % Versions.SttpClientVersion,
  "com.softwaremill.sttp.client3" %% "core"                           % Versions.SttpClientVersion,
  "com.softwaremill.sttp.client3" %% "json-common"                    % Versions.SttpClientVersion,
  ...
  "org.typelevel"                 %% "log4cats-noop"                  % Versions.Log4CatsVersion % Test,
