...
import geotrellis.raster.io.geotiff.reader.{GeoTiffReader, MalformedGeoTiffException}
...
object GeotiffReader extends LazyLogging {
  ...
  /** Helper function that gets a serializable GeoTiffInfo given
    ...
    * @return
    */
  def getGeotiffInfo(uri: String): SerializableGeotiffInfo = {
    ...
    SerializableGeotiffInfo.fromGeotiffInfo(geoTiffInfo, tiffTags)
  }
}
